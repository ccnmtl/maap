...
tinyMCE.init({
  ...
  theme_advanced_buttons1:((tinyMCE.isSafari) ? "bold, italic, underline, spacer, code" : "bold, italic, underline, spacer, bullist, numlist, spacer, undo, redo, spacer, link, unlink, image, spacer, code, pasteword"),
